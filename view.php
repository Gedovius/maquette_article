...
<html lang="en">
<head>
    <title>Maquette Abonnement</title>
    <meta charset="UTF-8">
...
<div class="form-check">
  <label class="form-check-label">
    ...
    <input type="checkbox" class="form-check-input" name="" id="" value="checkedValue" checked>CB VISA</input><br>
    <input type="checkbox" class="form-check-input" name="" id="" value="checkedValue" checked>MASTERCARD</input><br>
